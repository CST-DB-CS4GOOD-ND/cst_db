...
CREATE TABLE `experiences` (
  ...
  CONSTRAINT `experiences_ibfk_1` FOREIGN KEY (`quote_id`) REFERENCES `quotes` (`quote_id`)
...
CREATE TABLE `quotes` (
  ...
  CONSTRAINT `quotes_ibfk_1` FOREIGN KEY (`theme_id`) REFERENCES `themes` (`theme_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-28 15:17:13
